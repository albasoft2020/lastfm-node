...
var WRITE_METHODS = ["auth.getmobilesession","album.addtags", "album.removetag", "album.share",
...
//  HTTPS not needed? 'getmobilesession' seems to work without HTTPS
//  if (method.toLowerCase() === "auth.getmobilesession") {
//  // According to API documentation we should connect using HTTPS.
//        console.log("Get mobile session" + JSON.stringify(options));
